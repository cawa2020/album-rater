...
export default function Song({ index, song, toggleDisable, isDisabled }) {
		...
		<div className={isDisabled ? "song disabled" : "song"}>
			...
			<div className="flex gap-3 items-start">
				...
				<div className="flex gap-1">
					{[1, 1, 1].map((el, index) => (
						<button disabled={isDisabled} key={index} onClick={() => changeStars(index + 1)}>
							<svg className="star" width="23" height="21" viewBox="0 0 23 21" fill={stars > index ? "#EDDC35" : "none"} xmlns="http://www.w3.org/2000/svg">
								<path
			...
			<button onClick={() => toggleDisable(index)}>
